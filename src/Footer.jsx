...
function Footer() {
    ...
    <p>contact me:</p>
              ...
              <li><a className="gmail" href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=tromp1000@gmail.com" target='blank' ><i className="fa fa-google"></i></a></li>
            </ul>
            <div className="row">
            <h3>About</h3>
            <p><i>CODE WANTS TO BE SIMPLE</i></p>
            <p className="copyright-text">React &copy; 2023 All Rights Reserved by 
